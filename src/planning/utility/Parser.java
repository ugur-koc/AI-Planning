...
public class Parser {
	...
	// line = scanner.nextLine();
	// }
	// for (; !line.equalsIgnoreCase("StateVariables") && scanner.hasNext(); line
	// = scanner.nextLine());
	// line = scanner.nextLine();
	// while (!line.equals("")) {
	...
	// line = scanner.nextLine();
	// }
	// for (; !line.equalsIgnoreCase("Actions") && scanner.hasNext(); line =
	// scanner.nextLine());
	// line = scanner.nextLine();
	// while (!line.equals("")) {
	...
	// line = scanner.nextLine();
	// }
	// for (; !line.startsWith("s0") && scanner.hasNext(); line =
	// scanner.nextLine());
	...
	// }
	// scanner.close();
	// return new Problem(new StateTransitionSystem(states, actions),
	...
	// String[] param = split[0].substring(split[0].indexOf("("),
	// split[0].indexOf(")")).split(",");
	...
	// }
	//
	// private static Action createAction(String line, String preLine, String
	// effLine) {
	...
	// b.getPlanningObject(domLine.split("=")[1]).getElements(), null, null);//
	// TODO
	// }
}
